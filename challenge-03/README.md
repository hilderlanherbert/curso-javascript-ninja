...
*/
pessoa.nomeCompleto(); // Hilderlan Herbert
...
*/
    pessoa.apresentacao = function apresentacao() {
        ...
        const artigo = pessoa.sexo === 'M' ? ' a ' : ' o ';
        const plural = pessoa.idade === 1 ? ' ano ' : ' anos ';
         const metro = pessoa.caminhouQuantosMetros === 1 ? ' metro ' : ' metros ';

        console.log( 'Olá, eu sou'+ artigo  + pessoa.nome + ' ' +  pessoa.sobrenome + ' tenho ' + pessoa.idade + plural + pessoa.peso+ ' kg  e, ' + 'só hoje, eu já caminhei ' +  pessoa.caminhouQuantosMetros + ' metros');
    }
